...
__file__ = './neural_network/resnet.py'
...
./neural_network/resnet.py


Functions to retrieve: 
    * ResNet50 for classification task.
    * FCN with ResNet50 as feature extractor.
...
def ResNet50_FCN(input_shape=(224,224,3), n_classes=2, 
    ...
    '''
    Fully Convolutional Network with ResNet50 as feature extractor
    '''
...
def restore_model(input_shape, n_classes, weights_path):
    '''
    Restores the trained FCN model
    '''
...
lr_scheduler_function = lambda x: 1.0 * 0.8 ** x
